...
let
  ...
  cfg = config.ordenada.features.emacs.org-roam;
in
{
  options = {
      ...
      programs.emacs = {
        ...
        extraConfig = ''
          ...
          the node, relative to `org-roam-directory'."
            ...
            ${
              if cfg.captureTemplates == "" then
                ""
              else
                ''(setq org-roam-capture-templates ${cfg.captureTemplates})''
            })
          ...
          (with-eval-after-load 'org-roam-dailies
            (setq org-roam-dailies-directory "${cfg.dailiesDirectory}")
            ${
              if cfg.dailiesCaptureTemplates == "" then
                ""
              else
                ''(setq org-roam-dailies-capture-templates ${cfg.dailiesCaptureTemplates})''
            })
